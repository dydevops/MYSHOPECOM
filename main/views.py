...
import random
import string
from myshopecom.settings import KEY_ID, KEY_SECRET
...
class CartView(LoginRequiredMixin, View):
    def get(self, *args, **kwargs):
        try:
            ...
            return render(self.request, 'main/cart_items.html', context)
        ...
        try:
            ...
            if form.is_valid():
                ...
                if payment_option == "POD":
                    ...
                    return redirect("handle_payment", amount=amount)
            else:
...
def handle_payment(request, amount):
    if request.method == "GET":
        ...
        if order.billing_address:
            return render(request, "main/online_pay.html", {'amount': amount})
        else:
...
class RequestRefundView(View):
    def get(self, *args, **kwargs):
        ...
        return render(self.request, "main/refund.html", context)
